...
% KDE estimates the probability density function of the data and
% can be used to generate new samples based on this estimated distribution.
...
bandwidth = 0.4; % You can adjust this value based on your data
for i=1:NF
...
% Generate synthetic data using the estimated kernel density
